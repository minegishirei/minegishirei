...
<div class="field" style="display: flex;">
  ...
  <div style="padding-left: 10px">
    ...
    <p>
      エンジニア(7年)/マーケター(1年)です。<br/>
      ・エンジニア : ネイティブアプリケーション/バックエンド/フロントエンド/インフラ/SRE<br/>
      ・マーケター : toBマーケティング(LP制作からう共催ウェビナー準備など)/採用広報チームリードを担当
    </p>
  </div>
</div>

※ フルスタックグロース : **マーケターとしてディストリビューション戦略策定から携わり、エンジニアとしてシステム構築を行い、SREとして信頼性確保~行動分析による売上向上**
...
- リットシティ株式会社(業務委託)
  ...
  - [某都道府県警察本部向け開発案件におけるクラウドインフラの構築 : 機能追加改修]()
- 人材派遣企業(4年~：デジタル開発室)
  ...
  - [横断SRE](https://minegishirei.hatenablog.com/entry/2025/02/05/210239) : SREチームのメンバーとして、プロジェクトを横断する組織に所属する
  - [SRE NewRelic導入]()
  - [営業活動支援 顧客リスト作成システム](https://minegishirei.hatenablog.com/entry/2024/09/09/181927) : 営業活動における顧客リストを作成するプロジェクト。Salesforceのデータ連携の構築を行いました。
  - [マッチングサービス](https://minegishirei.hatenablog.com/entry/2025/08/22/090758) : 守秘
  - [共通データ基盤]() : 
  - [技術広報](https://psy.hatenadiary.com/entry/2025/10/22/203318) : 採用を目的とした技術広報の拡充のため、技術者のブログのライティングの敷居を下げる施策
- マーケティングSaaS(業務委託)
  - LP制作
  - toBマーケティング
- CTF
